    ...
    static void main() {
        ...
        do{
            try {
                ...
                String fecha_nacimiento_izq = fecha_nacimiento.substring(0,1);
                fecha_nacimiento_izq_entero = Integer.parseInt(fecha_nacimiento_izq);

                String fecha_nacimiento_centro = fecha_nacimiento.substring(3,4);
            ...
            if (fecha_nacimiento_izq_entero < 0 || fecha_nacimiento_centro_entero < 0 || fecha_nacimiento_derecha_entero < 0 ){
