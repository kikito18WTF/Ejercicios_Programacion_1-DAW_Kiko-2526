...
public class CosasNumeritos {
    ...
    static void main () {
        ...
        int resultado_izq=0;
        int resultado_centro=0;
        int resultado_derecha=0;
        ...
        resultado_derecha = multiplicador_derecha_int * multiplicando;
        resultado_centro = multiplicador_centro_int * multiplicando;
        resultado_izq = multiplicador_izquierda_int * multiplicando;
        ...
        do {
            ...
            if (multiplicando >= 100 || multiplicando <= 999 || multiplicador >= 100 || multiplicador <= 999 ){
                ...
                System.out.println(resultado_izq+ "xx"+ "  ");
                System.out.println("---------");
                System.out.println(resultado);


            }else {
                System.out.println("No se puede introducir numeros de 1 2 u 4 cifras. Solo numeros de 3 CIFRAS");
                repetir=true;
            }
